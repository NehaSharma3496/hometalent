...
const Category = () => {
  return (
    <div><section className="tour-list-section top-bottom-padding2">
        ...
        <div className="search-filter-section">
          ...
          <div className="price-filter">
            ...
            <div className="price-range-slider">
              <div id="slider-range" className="range-bar ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"><div className="ui-slider-range ui-corner-all ui-widget-header" style={{left: '0%', width: '32.4324%'}} /><span tabIndex={0} className="ui-slider-handle ui-corner-all ui-state-default" style={{left: '0%'}} /><span tabIndex={0} className="ui-slider-handle ui-corner-all ui-state-default" style={{left: '32.4324%'}} /></div>
