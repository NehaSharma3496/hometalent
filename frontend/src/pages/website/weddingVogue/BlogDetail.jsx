...
const BlogDetail = () => {
  return (
  <div>  <section className="destination-details-section top-bottom-padding2">
        ...
        <div className="col-xl-8 col-lg-7">
          ...
          <div className="news-details-content">
            <div className="d-flex flex-wrap align-items-center gap-20">
              ...
              <div className="count">
                <p className="pera">April 22, 2025</p>
              </div>
              <div className="divider" />
              <div className="count">
              ...
              <form method="post" className="contact-form">
                <div className="row g-4">
                  ...
                  <div className="col-sm-12">
                    <textarea className="custom-form-textarea" id="exampleFormControlTextarea1" rows={5} placeholder="Enter your message..." defaultValue={""} />
                  </div>
                </div>
                <div className="mt-40">
