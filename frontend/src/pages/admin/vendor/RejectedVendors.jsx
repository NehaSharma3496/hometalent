...
export default function RejectedVendors() {
  ...
  const exportToExcel = () => {
    const worksheet = XLSX.utils.json_to_sheet(rejectedvendors);
    const workbook = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(workbook, worksheet, "Rejected Vendor");

    XLSX.writeFile(workbook, "Rejected Vendor List.xlsx");
  };
